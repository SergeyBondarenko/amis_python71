print("Данная программа предназначена для расчёта возможностей перемещения\nшахматного коня по шахматной доске.")#Выводим приветствие и предназначение программы
...
distance1 = abs(x - x1)#Подсчет растояния между начальной и конечной клеткой
distance2 = abs(y - y1)#Подсчет растояния между начальной и конечной клеткой
if (0< x <9) and (0< x1 <9) and (0< y <9) and (0< y1 <9):#условие для правильного ввода данных
    if distance1 == 1 and distance2 == 2 or distance1 == 2 and distance2 == 1:#условие перевдвижения коня
